...
export default class UserService {
    ...
    static getUser(firstName: String, lastName: String, email: String): Promise<AxiosResponse<User>>{
        return $api.post<User>('hha-user/userProfile', {firstName, lastName, email})
    }
}
